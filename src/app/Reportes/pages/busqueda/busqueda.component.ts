...
export class BusquedaComponent implements OnInit {
  ...
  view(procedure: any) {
    ...
    this.router.navigate(
      [
        `home/reportes/busquedas/${
          this.groupProcedure === 'tramites_externos'
            ? 'ficha-externa'
            : 'ficha-interna'
        }`,
        procedure._id,
  ...
  selectGroupProcedure(group: any) {
    ...
    this.reporteService
      .getTypesProceduresForReports(group)
      .subscribe((data) => {
  ...
  selectInstitution(id_institucion: string) {
    this.reporteService
      .getDependenciasForReports(id_institucion)
  ...
  selectDependencia(dependence: any) {
    ...
    this.reporteService
      .getUsersForReports(dependence.id_dependencia)
      .subscribe((accounts) => {
