...
export async function PDF_FichaExterno(tramite: Externo, Workflow: WorkflowData[], funcionario: string) {
    ...
    let tableWorkflow: Table = {
        headerRows: 1,
        dontBreakRows: true,
        body: [[{ text: 'Remitente', style: 'tableHeader' }, { text: 'Proveido', style: 'tableHeader' }, { text: 'Fecha envio', style: 'tableHeader' }, { text: 'Destinatarios', style: 'tableHeader' }, { text: 'Fecha recibido', style: 'tableHeader' }]]
    }
